      ...
      {!data ? (
        <>
          <p className="font-bold">
            <span className="text-danger">Caution!</span> This action cannot be undone.
          </p>
          <p>
            Are you sure you want to reset <b>{user.username}</b> password?
          </p>
          <div className="flex justify-end gap-2">
            <Button variant="secondary" disabled={submitting} onClick={goBak}>
              Cancel
            </Button>
        ...
        <>
          <p>
            Password for <b>{username}</b> properly reset.
          </p>
          <p>
